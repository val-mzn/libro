...
urlpatterns = [
    ...
    path('author/<id>', authors.detail, name='author_detail'),
    ...
    path('book/<id>', books.detail, name='book_detail'),
    ...
    path('catalog/<id_catalog>/bookitem/<id_book>', catalogs.bookitem_detail, name='catalog_bookitem_detail'),
